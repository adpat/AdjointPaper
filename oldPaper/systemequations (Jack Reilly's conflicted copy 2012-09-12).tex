...
% \item Complete blocking of on-ramps when the mainline in congested at a 2x2 junction.\\
...
% \flowout{\icell}{\itime}
% =\begin{cases}
% \celldemand{\icell}{\item} 
% & \text{if } (\R{1}{\itime}{\icell}) : \frac{\priority{\icell}}{1-\priority{\icell}} > \frac{\celldemand{\icell}{\itime}}{\flowin{\icell+1}{\itime} - \celldemand{\icell}{\itime}}
% \\
% \frac{\flowin{\icell+1}{\itime}-\rampdemand{\icell}{\itime}}{1-\offrampratio{\icell}{\itime}}
% & \text{if } (\R{2}{\itime}{\icell}) : \frac{\priority{\icell}}{1-\priority{\icell}} < \frac{\flowin{\icell+1}{\itime}-\rampdemand{\icell}{\itime}}{\rampdemand{\icell}{\itime}}
% \\
