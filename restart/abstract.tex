...
\begin{abstract}
	...
	in order to minimize a given objective function. After discretizing the PDE system
	...
	number of discrete state variables. The method is applied to solve the problem of coordinated
	ramp metering on freeway networks. Numerical simulations on the I15 freeway in California demonstrate an improvement in performance
