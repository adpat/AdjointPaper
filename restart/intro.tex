...
One such approach approach, known as the \textit{adjoint method}, as applied to optimal
...
conditions in the continuous system~\cite{work2010traffic,garavello2006traffic,strub2006weak}.
Automatic differentiation techniques can simplify the repetetive 
...
The rest of the article is organized as follows. Section~\ref{sec:Preliminaries} gives an 
