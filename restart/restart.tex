...
\end{abstract}
\input{commands.tex}\input{nomenclature.tex}\input{intro.tex}\input{prelims.tex}\input{system.tex}\input{adjoint.tex}\input{ramp.tex}\input{numerical.tex}\input{conclusions.tex}
